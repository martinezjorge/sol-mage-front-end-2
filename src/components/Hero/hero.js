                ...
                <div class="centerpiece">
                    ...
                    <div className="text-box-container">
                        ...
                        <div className="text-box">
                            ...
                            <p className="text-box-p">Sol Mage Society is a collection of pixelated NFTs featuring a unique name, set of attributes, and spellbook with personalized attacks used to battle in the Sol Mage Arena. </p>
